...
const PROPERTY_TYPES = [
  ...
  'Commercial Showroom', 'Residential Land', 'Agricultural Land',
]
...
const CATEGORIES = ['Buy', 'Rent', 'Commercial', 'Plots & Land', 'New Launch']
...
const AddProperty = () => {
  ...
  const validate = (): boolean => {
    ...
    if (!form.area || isNaN(Number(form.area)) || Number(form.area) <= 0) e.area = 'Enter valid area'
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const priceDisplay = form.priceUnit === '₹/mo' ? `${priceNum}K/mo`
  ...
  return (
    <div className="min-h-screen bg-gray-50">
     ...
     <img src="./pageImg.jpg" alt="Background Image" className="object-cover object-center w-full h-full" />
  ...
  <div className="absolute inset-0 bg-black/40 flex flex-col items-center justify-center px-4 text-center">
    ...
    >
      ...
      <div className="max-w-4xl mx-auto  py-10 px-4">
        {/* Page Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900">Post Property <span className="text-primary-dull">Free</span></h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <select value={form.propertyType} onChange={e => set('propertyType', e.target.value)} className={inputCls('propertyType')}>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. 3 BHK Flat in Koramangala"
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            ...
            <p className="text-xs text-gray-400 mb-4">Upload up to 6 images (JPG, PNG). First image will be the cover.</p>
            ...
            <div className="flex flex-wrap gap-3">
              {previews.map((src, idx) => (
                <div key={idx} className="relative w-28 h-28 rounded-xl overflow-hidden border border-gray-200 group">
                  ...
                  {idx === 0 && (
                    <span className="absolute bottom-0 left-0 right-0 bg-primary/80 text-white text-[10px] text-center py-0.5">Cover</span>
                  )}
                  <button
                    type="button"
